...
export default function PatientForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setToast({ type: "success", message: t("Patient added successfully!"), visible: true });
        setPatient({
          firstName: "",
          lastName: "",
          departmentId: "",
        ...
        setToast({ type: "error", message: error.message || t("Something went wrong."), visible: true });
      }
    } catch (error) {
      console.error("Error submitting patient data:", error);
      setToast({ type: "error", message: t("Failed to add patient."), visible: true });
    }
  };

  return (
    <div className="container mt-5 mb-5">
      {toast.visible && <ToastMessage type={toast.type} message={toast.message} />}
